...
public class Algoritimo {
    ...
    public static Individuo[] crossover(Individuo individuo1, Individuo individuo2) {
        ...
        while (condition) {
            ...
            int pontoCorte1 = (r.nextInt((individuo1.getGenes().length() / PopularTurmas.bits) - 2) + 1);
            int pontoCorte2 = (r.nextInt((individuo1.getGenes().length() / PopularTurmas.bits) - 2) + individuo1.getGenes().length() / PopularTurmas.bits);
            ...
            if(!Verificacoes.verificarGene(geneFilho1) || !Verificacoes.verificarGene(geneFilho2)){
                continue;
            }else{
                condition = false;
            }
